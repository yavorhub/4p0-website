			...
			<div>
				...
				<section class="TeamImages">
					...
					<?php if($teamMemberThree['name']):?>
						<div>
							<a href="javascript:displayModal(1)"><img src="<?php echo $teamMemberThree['image']['sizes']['large'];?>" /></a>
							<h3 class="title-24"><?php echo $teamMemberThree['name'];?></h3>
						</div>
					<?php endif;?>
					<?php if($teamMemberFour['name']):?>
						<div>
							<a href="javascript:displayModal(1)"><img src="<?php echo $teamMemberFour['image']['sizes']['large'];?>" /></a>
							<h3 class="title-24"><?php echo $teamMemberFour['name'];?></h3>
						</div>
					<?php endif;?>
					<?php if($teamMemberFive['name']):?>
						<div>
							<a href="javascript:displayModal(1)"><img src="<?php echo $teamMemberFive['image']['sizes']['large'];?>" /></a>
